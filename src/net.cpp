...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Hardcoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"hardcointools.com", "dnsseed.hardcointools.com"},
    {"hardcoinpool.org", "dnsseed.hardcoinpool.org"},
...
static const char *strTestNetDNSSeed[][2] = {
    {"hardcointools.com", "testnet-seed.hardcointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Hardcoin is probably already running."), addrBind.ToString().c_str());
        else
